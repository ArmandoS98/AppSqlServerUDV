...
public class JugadorAdapterSub extends RecyclerView.Adapter<JugadorAdapterSub.ViewHolder> {
    private static final String TAG = "JugadorAdapter";
    private ArrayList<Jugador> valores;
    private Context context;

    public JugadorAdapterSub(Context context, ArrayList<Jugador> valores) {
